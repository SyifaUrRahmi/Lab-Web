...
<!-- Jika ada postingan, tampilkan -->
@if ($posts->count())
<div class="card mb-3">
@if($posts[0]->image)
      <div style="max-height: 400px; overflow:hidden;"><img src="{{ asset('storage/' . $posts[0]->image) }}" alt="
        {{ $posts[0]->category->name }}" class="img-fluid my-3">
      </div>
@else
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        <div class="position-absolute px-3 py-2 text-light rounded" style="background-color: rgba(0, 0, 0, 0.7)">
