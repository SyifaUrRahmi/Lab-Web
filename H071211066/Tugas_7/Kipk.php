 ...
 * Class Kipk untuk melakukan login dan registrasi user baru 
...

{
  ...
  ## Contructor untuk class Kipk, membutuhkan satu parameter yaitu koneksi ke database ## 
...

  {
    ...
    try {
      ...
      $stmt = $this->db->prepare("INSERT INTO user(nama, email, password) VALUES(:nama, :email, :pass)");
