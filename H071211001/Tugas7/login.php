...
<body>
    <?php
        ...
        if (isset($_POST['submit'])) 
        {
            ...
            $result = mysqli_query($con, "SELECT email, nama_pengguna, kata_sandi FROM `users` WHERE email='$email'") or die(mysql_error());
            ...
            if (mysqli_num_rows($result) == 1 && password_verify($password, $fetch->kata_sandi) > 0)
            {
                ...
                // Redirect pengguna ke halaman index.php
                header("Location: index.php");
            }
            else 
            {
                echo "<div class='form'>
                        <h3>Email atau kata sandi salah.</h3><br/>
