...
<body style="background : #8ea0bd">
    <div class="mx-auto">
        <!-- untuk memasukkan data -->
        <div class="card">
            <div class="card-header text-light" style="background : #05204a">
                Create / Edit Data
            </div>
            <div class="card-body">
                <?php
                ...
                <form action="" method="POST">
                    ...
                    <div class="col-12">
                        <input type="submit" name="simpan" value="Simpan Data" class="btn text-light" style="background : #3260a8" />
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header text-white" style="background : #05204a">
                Data Mahasiswa
            </div>
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="index.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn text-light" style="background : #95a9c9">Edit</button></a>
                                    <a href="index.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn text-light" style="background : #3260a8">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
